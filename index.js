...
function filterStudentsByGrade(students, grade) {
  ...
  const result = students.filter(students => students.grade === grade)
  ...
  result.forEach(students => console.log(`Студент: ${students.name}, Оцінка: ${students.grade}`))
  return result
}
...
function compareArrays(arr1, arr2) {
  ...
  return console.assert(json1 === json2, 'Масиви не однакові!')
}
...
function countVowelsAndConsonants(word) {
  ...
  for (let letter of word) {
    ...
    // Перевіряємо, чи є літера в нашому рядку з голосними, якщо так, то виводимо лічильник голосних, інакше приголосних
    if (vowels.indexOf(lowerLetter) !== -1) {
      vowelCount++; // Літера є голосною
    } else {
      consonantCount++; // Літера є приголосною
    }
  }
